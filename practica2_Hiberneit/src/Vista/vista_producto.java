...
import controller.presentacion;
...
Marca mar_res=cm.buscarMarca(id_marca.getText());
Presentacion pre_res=cpre.buscarPresentacion(id_presentacion.getText());
Proveedor pro_res=cpr.buscarProveedor(id_proveedor.getText());
Zona zon_res=cz.buscarZona(id_zona.getText());
...
vista_proveedor AP = new vista_proveedor();
AP.setVisible(true);
        // TODO add your handling code here:
