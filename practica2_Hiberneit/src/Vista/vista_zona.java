...
public class vista_zona extends javax.swing.JFrame {
zona cz;
    public vista_zona() {
        initComponents();
         cz = new zona();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       vista_producto AP = new vista_producto();
       AP.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vista_zona.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vista_zona().setVisible(true);
            }
        });
    }
